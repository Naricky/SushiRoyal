<template>
    <div>
      <div class="backgroundCommentImage">
        <div class='catchyTitle'> Customer Comments</div>
        <hr>
      <div class='comments'>
        <ul id="messages">
          <li>
          ...
          <li>
           ...
           <li>
            <div class="infos">
              <!-- <img src="../assets/menuback.jpg" alt="" title="customer" /> -->
            </div>
          <li>
          <div class="content">
            <h3>
...
body {
  background: url("http://i58.tinypic.com/2586qdx.jpg");
  font: 15px/150% serif; }
